...
<head>
    ...
    <title>NARA - Supporting Divisions</title>
...
?>
 <!-- Page Header Start -->
    <div class="container-fluid page-header4">
        <h1 class="display-3 text-uppercase text-white mb-3 glow-text">Supporting Divisions</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a href="">Home</a></h6>
            <h6 class="text-white m-0 px-3">/</h6>
            <h6 class="text-uppercase text-white m-0">Supporting Divisions</h6>
        </div>
    </div>
    <!-- Page Header End -->
...
<div class="container py-5">
    ...
    url('img/sd3.png') center/cover no-repeat;">
              <div class="inner">
                <h3 class="flip-box-header">Administrative</h3>
                <p> Division </p>
                <img src="https://s25.postimg.cc/65hsttv9b/cta-arrow.png" alt="" class="flip-box-img">
              </div>
            </div>
            <div class="flip-box-back" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('img/sd3.png');">
              <div class="inner">
                <h3 class="flip-box-header">Administrative </h3>
                <p>Division</p>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="box-item">
          <div class="flip-box">
            <div class="flip-box-front" style=" background: 
    linear-gradient(rgba(65, 148, 163, 0.8), rgba(49, 141, 177, 0.8)), 
    url('img/sd2.png') center/cover no-repeat;">
              <div class="inner">
                <h3 class="flip-box-header">Finance </h3>
                <p>Division</p>
                <img src="https://s25.postimg.cc/65hsttv9b/cta-arrow.png" alt="" class="flip-box-img">
              </div>
            </div>
            <div class="flip-box-back" style="background-image:linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),  url('img/sd2.png');">
              <div class="inner">
                <h3 class="flip-box-header">Finance </h3>
                <p>Division</p>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="box-item">
          <div class="flip-box">
            <div class="flip-box-front" style=" background: 
    linear-gradient(rgba(65, 148, 163, 0.8), rgba(49, 141, 177, 0.8)), 
    url('img/sd1.png') center/cover no-repeat;">
              <div class="inner">
                <h3 class="flip-box-header">Service & Operation</h3>
                <p>Division</p>
                <img src="https://s25.postimg.cc/65hsttv9b/cta-arrow.png" alt="" class="flip-box-img">
              </div>
            </div>
            <div class="flip-box-back" style="background-image:linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),  url('img/sd1.png');">
              <div class="inner">
                <h3 class="flip-box-header">Service & Operation</h3>
                <p>Division</p>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card border-dark">
                <div class="card-body text-center p-4 p-xxl-5">
                  ...
                  <h5 class="mb-4">Administrative Division</h5>
                  <p class="mb-4 text-secondary"></p>
                  <a href="divs-ad.php" class="btn btn-outline-primary bsb-btn-circle">
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card border-dark">
                <div class="card-body text-center p-4 p-xxl-5">
                  ...
                  <h5 class="mb-4">Finance Division</h5>
                  <p class="mb-4 text-secondary"></p>
                  <a href="divs-fd.php" class="btn btn-outline-primary bsb-btn-circle">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
                    </svg>
                  </a>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card border-dark">
                <div class="card-body text-center p-4 p-xxl-5">
                  ...
                  <h5 class="mb-4">Service & Operation Division</h5>
                  <p class="mb-4 text-secondary"></p>
