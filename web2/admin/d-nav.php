...
<!--<ul class="collapse list-unstyled pl-4 w-100" id="dashboard">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown">
              <a href="vacancy-manage.php"  aria-expanded="false" class=" nav-link">
                <i class="fe fe-credit-card fe-16"></i>
                <span class="ml-3 item-text">Vacancy</span>
              </a>
             ...
             <li class="nav-item w-100">
              <a class="nav-link" href="widgets.html">
                ...
                <span class="ml-3 item-text">Session</span>
            ...
            <li class="nav-item dropdown">
              <a href="#tables" data-toggle="collapse" aria-expanded="false" class=" nav-link">
                ...
                <span class="ml-3 item-text">Procument</span>
              </a>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="charts">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="./chart-inline.html"><span class="ml-1 item-text">Division</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="./chart-chartjs.html"><span class="ml-1 item-text">Designation</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="emp_manage.php"><span class="ml-1 item-text">Staff</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="gmembers.php"><span class="ml-1 item-text">Board Members</span></a>
                </li>
              </ul>
            </li>
          </ul>
